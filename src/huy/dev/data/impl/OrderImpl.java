...
public class OrderImpl implements OrderDao{
	Connection con = (Connection) MySQLDriver.getInstance().getConnection();
	@Override
	...
	public boolean update(Order order) {
        ...
        try {
            ...
            stmt.setString(2, order.getStatus());
            stmt.setInt(3, order.getUserId());
       //     stmt.setTime(4, order.getCreatedAt());
	...
	public Order find(int id) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                return new Order(code, status, userId);
            }
        } catch (SQLException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
	...
	public List<Order> findAll() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                int userId = rs.getInt("user_id");
                Timestamp created_at = rs.getTimestamp("created_at");
                orders.add(new Order(code, status, userId));
            }
        } catch (SQLException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
	...
	public List<Order> findByUser(int userId) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                orderList.add(new Order(code, status, userId));
            }
        } catch (SQLException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
